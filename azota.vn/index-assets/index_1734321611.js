                ...
                <div class="col-sm-8">
                    <div style="border: 1px solid #ccc; padding: 10px; border-radius: 3px; background: white; margin: 16px">
                        ...
                        <div id="unSupportNormalBrowser" style="display: none;">
                            ...
                            <p><span class="aztTranslate" lang="lang_index_browser_chrome_android"></span>: <a href="https://apps.apple.com/us/app/google-chrome/id535886823" target="_blank">https://apps.apple.com/us/app/google-chrome/id535886823</a></p>
                        </div>
...
function testInternetSpeed() {
    try {
        ...
        var testFileURL = '/index-assets/test_internet_speed.mp3';
        fetch(testFileURL)
